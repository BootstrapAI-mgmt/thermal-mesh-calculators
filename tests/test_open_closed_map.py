...
ever observed passing is not evidence it works.
...
def _find_repo_root() -> Path:
    ...
    Not ``parent.parent``: the test file is not always exactly one level below the
    root, and a fixed number of levels silently resolves to the wrong root there.
    """
