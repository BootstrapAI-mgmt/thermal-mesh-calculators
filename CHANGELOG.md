...
- **Changed:** the repository is published under the same name from a fresh public history
  (decision D21, 2026-09-17); the private development history is retained at
  `BootstrapAI-mgmt/thermal-mesh-calculators-private`. The internal productization corpus
  was removed ahead of publication; `CLAUDE.md` and `README.md` counts were re-measured
  (43 materials, 239 tests in-tree).
