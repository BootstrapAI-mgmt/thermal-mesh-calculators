...
which rule put it there. That map is
...
This file is self-contained on purpose: the repository has to be independently
checkable.
"""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if "tracked_files" in report:
        ...
        if report["underivable"]:
            print(f"  UNDERIVABLE:    {len(report['underivable'])} path(s) need a maintainer ruling")
